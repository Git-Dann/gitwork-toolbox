...
const GROUPS = [
  {
    ...
    categories: [
      ...
      "Design engineering / canvas SDK",
      "Design engineering / icons",
      "Design engineering / illustration",
      "Design engineering / colour",
      "Design systems / AI reference",
      "Design systems / design engineering",
      "Design tools / editors",
      "Design tools / site builders",
      "Design engineering / diagrams",
      ...
      "Design inspiration / micro-interactions",
  ...
  },
  {
    ...
    categories: [
      ...
      "AI coding / model hosting",
      "AI coding / agent frameworks",
      "AI coding / conversational agents",
      "AI coding / model providers",
      "Data / analysis",
  ...
  },
  {
    ...
    categories: [
      ...
      "Video & capture / generation",
      "Audio / production",
      "Typography / free fonts",
      "Creative ops / image optimisation",
    ],
  },
  {
    ...
    categories: [
      ...
      "Mac software / file handling",
      "Mac software / browsers",
      "Mac software / file transfer",
...
for (const entry of additionsByKind.tool) {
  ...
  tools.push({
    ...
    // Pinned means first in every list it appears in — one deliberate top of the pile.
